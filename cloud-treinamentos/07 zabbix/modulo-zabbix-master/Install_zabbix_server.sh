...
mysql -h zabbix.cnkszocehfje.us-east-1.rds.amazonaws.com -uadminadmin -padminadmin
...
zcat /usr/share/doc/zabbix-server-mysql*/create.sql.gz | mysql -h zabbix.cnkszocehfje.us-east-1.rds.amazonaws.com -uadminadmin -padminadmin zabbix
